  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="PatientHome" component={PatientHomeScreen} options={{ title: 'Smriti 🧠', headerLeft: () => null }} />
        ...
        <Stack.Screen name="CaregiverHome" component={CaregiverHomeScreen} options={{ title: 'Smriti — Caregiver 👩‍⚕️', headerLeft: () => null }} />
        <Stack.Screen name="Analysis" component={AnalysisScreen} options={{ title: 'Patient Analysis 📊' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}
